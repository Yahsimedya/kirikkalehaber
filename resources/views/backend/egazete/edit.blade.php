...
@section('admin')
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{route("egazete.edit",$edit)}}" enctype="multipart/form-data">
                @csrf
                <div class="form-group row">
                    <div class="col-lg-12">
                        <label>Gazete Sayı</label>

                        <input type="text" name="title_tr" value="{{$edit->title_tr}}" required="" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="tarih"  class="form-control daterange-increments" name="date" value="{{$edit->date}}">
                    </div>
                </div>
               <div class="row">
                   <div class="col-md-9">
                   ...
                   <div class="col-md-3">
                       <img width="200" src="{{asset($edit->image)}}">
                   </div>
               </div>

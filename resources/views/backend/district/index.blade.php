...
@section('admin')
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">Tüm Bölgeler</h5>
        ...
        <div class="card-body">
            ...
            <a href="{{route('add.district')}}"><button type="button" class="float-right btn bg-teal-400 btn-labeled btn-labeled-left"><b><i class="icon-pen-plus"></i></b> Bölge Ekle</button></a>
...
@endphp
                @foreach ($district as $row )
                    ...
                    <td> @if ($row->district_status == 1)
                        {{-- <span class="badge badge-success">Aktif</span> --}}
                        <form action="{{ route('active.district', $row->id) }}" method="post">
                            @csrf
                        ...
                        <div class="list-icons">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{route('edit.district',$row->id)}}" class="dropdown-item"><i class="icon-pencil6"></i> Düzenle</a>
                                    <a href="{{route('delete.district',$row->id)}}" onclick="return confirm('Silmek istediğinizden emin misiniz ?')" class="dropdown-item"><i class="icon-trash"></i>Sil</a>

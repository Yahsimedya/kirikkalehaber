...
<div class="card-body">
    <form action="{{route('update.district',$district)}}" method="post">
@csrf
    <fieldset class="mb-3">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <input type="text"  name="district_tr" value="{{$district->district_tr}}" class="form-control">
                @error('district_tr')
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <input type="text" name="district_en" value="{{$district->district_en}}" class="form-control">
                @error('district_en')
                <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <textarea class="form-control" name="district_keywords"  id="" cols="30" rows="10">{{$district->district_keywords}}</textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <textarea class="form-control" name="district_description"  id="" cols="30" rows="10">{{$district->district_description}}</textarea>

...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('update.galerycategory', $photocategory)}}" method="post">
            @csrf
            <fieldset class="mb-3">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="category_title" value="{{$photocategory->category_title}}"
                               class="form-control">
                        @error('title')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <textarea class="form-control" name="keywords_tr" id="" cols="30"
                                          rows="10">{{$photocategory->keywords_tr}}</textarea>
                                @error('keywords_tr')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <textarea class="form-control" name="description_tr" id="" cols="30"
                                          rows="10">{{$photocategory->description_tr}}</textarea>

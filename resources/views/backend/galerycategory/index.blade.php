...
@section('admin')
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">Galeri Kategorileri</h5>
        ...
        <div class="card-body">
            ...
            <a href="{{route('add.galerycategory')}}"><button type="button" class="float-right btn bg-teal-400 btn-labeled btn-labeled-left"><b><i class="icon-pen-plus"></i></b> Galeri Kategori Ekle</button></a>
...
@endphp
                ...
                <tr>
                    <td>{{$i++}}</td>
                    <td>{{$kategori->category_title}}</td>
                    {{-- <td>{{$kategori->category_en}}</td> --}}
                    <td>@if ($kategori->status==1)
                        <form action="{{route('active.galerycategory',$kategori->id)}}" method="post">
                            @csrf
                        ...
                        <div class="list-icons">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{route('edit.galerycategory',$kategori->id)}}" class="dropdown-item"><i class="icon-pencil6"></i> Düzenle</a>
                                    <a href="{{route('delete.galerycategory',$kategori->id)}}" onclick="return confirm('Silmek istediğinizden emin misiniz ?')" class="dropdown-item"><i class="icon-trash"></i>Sil</a>

    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <!-- Default box -->
                ...
                <form id="form" action="{{route('add.text', $photo->photocategory_id)}}" method="POST"
                    ...
                    <div align="right" class="col-md-12">
                        <button id="btnn" type="submit" name="action" class="btn btn-danger float-right "><i
                                class="icon-redo" aria-hidden="true" value="updatephoto"></i> Güncelle
                        </button>

                     <a class="btn btn-success" href="{{route('galery.detailAdd',$photo->photocategory_id,1)}}"><i class="icon-cloud-upload" aria-hidden="true"></i>Fotoğraf Yükle</a>
                    </div>
                        ...
                        @foreach ($photos as $foto )
                            ...
                            <div class="col-md-3" id="item-">
                                <div style="padding:5px; margin-top:10px; border-radius:5px;border: 1px solid #c9c9c9;">
                                    <label>
                                        <input type="hidden" class="form-check-input-styled-success" name="eskiyol[]"
                                               value="{{$foto->photo}}">
                                        ...
                                        <div class="image view view-first sortable" style="margin-top:20px;">
                                            ...
                                            <textarea class="form-control mt-2" name="photo_text[]" id="" cols="30"
                                                      rows="5">{{$foto->photo_text}}</textarea></div>

                                        {{-- <input type="text" name="tekliyol"  value="{{asset($foto->photo)}}" > --}}

                                        <input type="hidden" name="fotogaleri_fotoid[]" value="{{$foto->id}}">
                                        <a href="{{route('delete.photo',$foto->id)}}" type="submit"
                                           id="deleteRecord{{$foto->id}}" name="action" class="btn btn-danger"><i
                                                class="icon-trash" aria-hidden="true" value="sil"></i> Sil</a>

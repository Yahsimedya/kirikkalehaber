...
@section('admin')
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('update.authorsposts',$cornerposts)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Başlık</label>
                                            <input type="text" value="{{$cornerposts->title}}" name="title" class="form-control">
                                            @error('title')

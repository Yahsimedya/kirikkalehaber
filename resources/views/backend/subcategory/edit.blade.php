...
<div class="card-body">
    <form action="{{route('update.subcategory',$subcategory)}}" method="post">
@csrf
    <fieldset class="mb-3">
   ...
   <div class="form-group  row">
                                ...
                                <select data-placeholder="Select a State..." name="category_id"
                                    ...
                                    @foreach ($category as $kategori)
                                        ...
                                        <option value="{{ $kategori->id }}"
                                            @php
                                                if($kategori->id== $subcategory->category_id) echo "selected";
                                            @endphp
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <input type="text"  name="subcategory_tr" value="{{$subcategory->subcategory_tr}}" class="form-control">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <input type="text" name="subcategory_en" value="{{$subcategory->subcategory_en}}" class="form-control">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <textarea class="form-control" name="subcategory_keywords"  id="" cols="30" rows="10">{{$subcategory->subcategory_keywords}}</textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <textarea class="form-control" name="subcategory_description"  id="" cols="30" rows="10">{{$subcategory->subcategory_description}}</textarea>

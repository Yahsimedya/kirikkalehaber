...
@section('title',$posts->title_tr)
@section('meta_keywords',$posts->keywords_tr)
@section('meta_description',$posts->description_tr)
@section('google_analytics',$seoset->google_analytics)
@section('og:site_name',$seoset->meta_title)
@section('og:title',$posts->title_tr)
@section('og:description',$posts->title_tr)
@section('og:image',asset($posts->image))
@section('og:url',url()->current())
@section('twitter:url',url()->current())
@section('twitter:domain',Request::root())
@section('twitter:site',$seoset->meta_title)
@section('twitter:title',$posts->title_tr)
